...
class StoreJewelleryStockRequest extends FormRequest
{
    ...
    {
        return [
            'sku' => 'required|string|unique:jewellery_stocks,sku|max:255',
            ...
            'side_stones.*.stone_type_id' => 'nullable|exists:stone_types,id',
            'side_stones.*.carat_weight' => 'nullable|numeric|min:0',
            'side_stones.*.count' => 'nullable|integer|min:0',
            'side_stones.*.total_weight' => 'nullable|numeric|min:0',
            ...
            'certificate_image_file' => 'nullable|file|mimes:jpeg,png,jpg,webp,avif,pdf|max:10240',
