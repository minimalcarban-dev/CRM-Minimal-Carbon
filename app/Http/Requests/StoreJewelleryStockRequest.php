...
class StoreJewelleryStockRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'primary_stone_price' => 'nullable|numeric|min:0',
            'primary_stone_count' => 'nullable|integer|min:0',
            'primary_stone_measurement' => 'nullable|string|max:100',
            ...
            'side_stones.*.price' => 'nullable|numeric|min:0',
            'side_stones.*.count' => 'nullable|integer|min:0',
            'side_stones.*.measurement' => 'nullable|string|max:100',
