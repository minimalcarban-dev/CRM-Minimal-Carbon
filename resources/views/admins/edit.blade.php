...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header mb-4">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div>
                    ...
                    <p class="page-subtitle mb-0">Update administrator details for {{ $admin->name }}</p>
                </div>
        ...
        <!-- Admin Info Banner -->
        <div class="admin-info-banner mb-4">
            <div class="admin-avatar-small">
                {{ strtoupper(substr($admin->name, 0, 2)) }}
            </div>
            <div class="admin-info-text">
                <h5 class="mb-1">Editing: {{ $admin->name }}</h5>
        ...
        <form method="POST" action="{{ route('admins.update', $admin) }}" enctype="multipart/form-data" id="editAdminForm">
            @csrf
            @method('PUT')
            ...
            <div class="form-section-card mb-4">
                <div class="section-header">
                    ...
                    <button type="button" id="suggestPw" class="btn btn-sm btn-outline-primary">
                        <i class="bi bi-stars me-2"></i>Generate New Password
                    </button>
                </div>
                <div class="section-body">
                    <div class="alert alert-info-modern mb-2 mb-md-4 mb-xl-4">
                        <i class="bi bi-info-circle me-2"></i>
                        <div>
                            <strong>Password Security</strong>
                            <p class="mb-0">The existing password is encrypted and cannot be displayed. Only enter a new password if you want to change it.</p>
                        </div>
                    </div>
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="form-group-modern">
                                ...
                                <div class="password-input-wrapper">
                                    <input id="password" type="password" name="password" 
                                           class="form-control-modern" placeholder="Enter new password (leave blank to keep current)">
                                    <button type="button" id="togglePassword" class="password-toggle-btn" 
                                            title="Show/Hide password">
                                        <i class="bi bi-eye"></i>
                                    </button>
                                </div>
                                <div class="password-strength-wrapper mt-3" style="display: none;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group-modern">
                                ...
                                <input id="confirm_password" type="password" name="confirm_password" 
                                       class="form-control-modern" placeholder="Re-enter new password">
                        ...
                        <div class="col-md-3">
                            <div class="form-group-modern">
                                ...
                                <input type="text" name="country_code" class="form-control-modern" 
                                       value="{{ old('country_code', $admin->country_code) }}" placeholder="+91">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group-modern">
                        ...
                        <div class="col-md-6">
                            <div class="form-group-modern">
                                ...
                                <input type="text" name="pincode" maxlength="6" class="form-control-modern"
                                       value="{{ old('pincode', $admin->pincode) }}" placeholder="380001">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group-modern">
                                ...
                                <input type="text" name="country" class="form-control-modern" 
                                       value="{{ old('country', $admin->country) }}" placeholder="India">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group-modern">
                                ...
                                <input type="text" name="state" class="form-control-modern" 
                                       value="{{ old('state', $admin->state) }}" placeholder="Gujarat">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group-modern">
                                ...
                                <input type="text" name="city" class="form-control-modern" 
                                       value="{{ old('city', $admin->city) }}" placeholder="Ahmedabad">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group-modern">
                                ...
                                <textarea name="address" class="form-control-modern" rows="3" 
                                          placeholder="Enter complete address">{{ old('address', $admin->address) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-section-card mb-4">
                <div class="section-header">
                    <div class="section-info">
                        ...
                        <div>
                            <h5 class="section-title">Update Documents</h5>
                            <p class="section-description">Upload new documents to replace existing ones (JPG/PNG only)</p>
                        </div>
                    </div>
                </div>
                <div class="section-body">
                    <div class="row g-4">
                        <!-- Aadhar Front -->
                        <div class="col-md-4">
                            <div class="file-upload-modern-edit">
                                <label class="form-label-modern mb-2 mb-lg-3 mb-xl-3 mb-md-3 mb-sm-3">
                                    <i class="bi bi-card-image me-2"></i>Aadhar Front
                                </label>
                                @if ($admin->aadhar_front_image)
                                    <div class="existing-image-preview">
                                        <img src="{{ Storage::url($admin->aadhar_front_image) }}" alt="Current Aadhar Front" />
                                ...
                                <label for="aadhar_front" class="file-upload-label-compact">
                                    <i class="bi bi-cloud-upload me-2"></i>
                                    {{ $admin->aadhar_front_image ? 'Replace Image' : 'Upload Image' }}
                                </label>
                        ...
                        <div class="col-md-4">
                            <div class="file-upload-modern-edit">
                                <label class="form-label-modern mb-3">
                                    <i class="bi bi-card-image me-2"></i>Aadhar Back
                                </label>
                                @if ($admin->aadhar_back_image)
                                    <div class="existing-image-preview">
                                        <img src="{{ Storage::url($admin->aadhar_back_image) }}" alt="Current Aadhar Back" />
                                        <div class="image-badge">
                                            <i class="bi bi-check-circle me-1"></i>Current
                                        </div>
                                    </div>
                                ...
                                <input type="file" name="aadhar_back_image" id="aadhar_back" 
                                       class="file-input-modern" accept="image/jpeg,image/png">
                                <label for="aadhar_back" class="file-upload-label-compact">
                                    <i class="bi bi-cloud-upload me-2"></i>
                                    {{ $admin->aadhar_back_image ? 'Replace Image' : 'Upload Image' }}
                                </label>
                        ...
                        <div class="col-md-4">
                            <div class="file-upload-modern-edit">
                                <label class="form-label-modern mb-3">
                                    <i class="bi bi-bank me-2"></i>Bank Passbook
                                </label>
                                @if ($admin->bank_passbook_image)
                                    <div class="existing-image-preview">
                                        <img src="{{ Storage::url($admin->bank_passbook_image) }}" alt="Current Bank Passbook" />
                                        <div class="image-badge">
                                            <i class="bi bi-check-circle me-1"></i>Current
                                        </div>
                                    </div>
                                ...
                                <input type="file" name="bank_passbook_image" id="bank_passbook" 
                                       class="file-input-modern" accept="image/jpeg,image/png">
                                <label for="bank_passbook" class="file-upload-label-compact">
                                    <i class="bi bi-cloud-upload me-2"></i>
                                    {{ $admin->bank_passbook_image ? 'Replace Image' : 'Upload Image' }}
                                </label>
    ...
    @push('styles')
        <style>
            ...
            /* File Upload Edit Style */
            .file-upload-modern-edit {
                position: relative;
            }
            ...
            [data-theme="dark"] .admin-info-banner,
            ...
            [data-theme="dark"] .admin-info-text h5,
            ...
            [data-theme="dark"] .admin-info-text p,
            ...
            [data-theme="dark"] .existing-image-preview {
                border-color: rgba(148, 163, 184, 0.3) !important;
            }
        ...
        <script>
            (function () {
                        ...
                        suggestBtn.addEventListener('click', function () {
                            ...
                            if (navigator.clipboard && navigator.clipboard.writeText) {
                                navigator.clipboard.writeText(out).then(function () {
                                    showToastNotification('New password generated and copied to clipboard', 'success');
                                }).catch(function () {
                                    showToastNotification('New password generated', 'success');
                                });
                            } else {
                                showToastNotification('New password generated', 'success');
                            }
                                    ...
                                    reader.onload = function(e) {
                                        ...
                                        preview.innerHTML = 
                                            ...
                                            '<div class="file-preview-info">' +
                                                '<span class="file-preview-name"><i class="bi bi-file-image me-2"></i>' + file.name + '</span>' +
                                                '<button type="button" class="file-remove-btn" data-target="' + id + '">' +
                                                    '<i class="bi bi-x"></i>' +
                                                '</button>' +
                                            '</div>';
                ...
                if (document.readyState === 'loading') {
                    document.addEventListener('DOMContentLoaded', initEditAdminForm);
                } else {
                    initEditAdminForm();
                }
            })();
