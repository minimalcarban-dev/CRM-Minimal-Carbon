        ...
        <div class="attr-page-header">
            <div class="attr-header-content">
                <div class="attr-header-left">
                    ...
                    <h1 class="attr-page-title"><i class="bi bi-plus-circle"></i> Create Stone Color</h1>
                    <p class="attr-page-subtitle">Add a new stone color to your inventory</p>
                </div>
        ...
        <div class="attr-form-card">
            <div class="attr-form-card-header">
                ...
                <div class="attr-form-card-title">
                    ...
                    <p>Enter the information for the new stone color</p>
                </div>
            </div>
                ...
                <form method="POST" action="{{ route('stone_colors.store') }}">
                    ...
                    <div class="attr-form-group">
                        ...
                        <input type="text" name="name" class="attr-form-input @error('name') is-invalid @enderror"
                            value="{{ old('name') }}" placeholder="e.g., Red, Blue, Green" required autofocus>
                    ...
                    <div class="attr-form-actions">
                        <a href="{{ route('stone_colors.index') }}" class="attr-btn-cancel"><i class="bi bi-x-circle"></i>
                            Cancel</a>
                        <button type="submit" class="attr-btn-submit"><i class="bi bi-check-circle"></i> Create Stone
                            Color</button>
                    </div>
                </form>
            </div>
