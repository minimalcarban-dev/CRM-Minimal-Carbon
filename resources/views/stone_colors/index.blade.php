    ...
    <div class="attr-list-container">
            ...
            <div class="attr-header-content">
                ...
                @if ($currentAdmin && $currentAdmin->hasPermission('stone_colors.create'))
                    <div class="attr-header-right">
                        <a href="{{ route('stone_colors.create') }}" class="attr-btn-create"><i class="bi bi-plus-circle"></i>
                            Add Stone Color</a>
                    </div>
                @endif
            </div>
        ...
        <div class="attr-filter-section">
            <form method="GET" class="attr-filter-form">
                ...
                @if(request('search'))<a href="{{ route('stone_colors.index') }}" class="attr-btn-reset"><i
        ...
        <div class="attr-table-card">
                        ...
                        @foreach ($items as $item)
                            <tr class="attr-row">
                                ...
                                <td class="attr-actions">
                                    @if ($currentAdmin && $currentAdmin->hasPermission('stone_colors.view'))<a
                                        href="{{ route('stone_colors.show', $item->id) }}" class="attr-action-btn view"><i
                                    class="bi bi-eye"></i></a>@endif
                                    @if ($currentAdmin && $currentAdmin->hasPermission('stone_colors.edit'))<a
                                        href="{{ route('stone_colors.edit', $item->id) }}" class="attr-action-btn edit"><i
            ...
            @else
                <div class="attr-empty-state">
                    ...
                    <p>Get started by adding your first stone color.</p><a href="{{ route('stone_colors.create') }}"
