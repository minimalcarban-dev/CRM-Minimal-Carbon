...
@section('title', 'Edit Stone Color')
    ...
    <div class="attr-form-container">
        <div class="attr-page-header">
            <div class="attr-header-content">
                <div class="attr-header-left">
                    ...
                    <h1 class="attr-page-title"><i class="bi bi-pencil-square"></i> Edit Stone Color</h1>
                    <p class="attr-page-subtitle">Update stone color information</p>
                </div>
        ...
        <div class="attr-form-card">
            <div class="attr-form-card-header">
                <div class="attr-form-card-icon"><i class="bi bi-palette"></i></div>
                <div class="attr-form-card-title">
                    <h2>Stone Color Details</h2>
                    <p>Update the stone color information</p>
                </div>
            </div>
            <div class="attr-form-card-body">
                <form method="POST" action="{{ route('stone_colors.update', $item->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="attr-form-actions">
                        <a href="{{ route('stone_colors.index') }}" class="attr-btn-cancel"><i class="bi bi-x-circle"></i>
                            Cancel</a>
                        <button type="submit" class="attr-btn-submit"><i class="bi bi-check-circle"></i> Update Stone
                            Color</button>
                    </div>
                </form>
            </div>
