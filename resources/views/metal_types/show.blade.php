        ...
        <div class="attr-page-header">
            <div class="attr-header-content">
                <div class="attr-header-left">
                    ...
                    <h1 class="attr-page-title"><i class="bi bi-eye"></i> Metal Type Details</h1>
                    <p class="attr-page-subtitle">View metal type information</p>
                </div>
        ...
        <div class="attr-detail-card">
            <div class="attr-detail-header">
                <div class="attr-detail-info">
                    <div class="attr-detail-icon"><i class="bi bi-award"></i></div>
                    <div class="attr-detail-title">
                        <h2>{{ $item->name }}</h2>
                        <p>Metal Type Information</p>
                    </div>
                </div>
            ...
            <div class="attr-detail-body">
                ...
                <div class="attr-detail-actions">
                    <a href="{{ route('metal_types.edit', $item->id) }}" class="attr-btn-edit"><i class="bi bi-pencil"></i>
                        Edit</a>
                    <form action="{{ route('metal_types.destroy', $item->id) }}" method="POST" style="display:inline;"
