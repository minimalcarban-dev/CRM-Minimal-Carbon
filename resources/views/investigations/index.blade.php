...
@section('content')
                ...
                <div class="sidebar-scroll">
                    @forelse($investigations as $investigation)
                        ...
                        <div class="inv-card {{ $loop->first ? 'active' : '' }}"
                            onclick="loadInvestigation({{ $investigation->id }}, this)" id="item-{{ $investigation->id }}">
    ...
    <style>
        ...
        .tag-pending {
            background: var(--inv-tag-pending);
            color: var(--inv-tag-pending-text);
        }
        ...
        .tag-in-progress,
        .tag-carrier-contacted {
            background: var(--inv-tag-active);
            color: var(--inv-tag-active-text);
        }

        .tag-in-progress .tag-dot,
        .tag-carrier-contacted .tag-dot {
            background: var(--inv-tag-active-text);
        }

        .tag-resolved,
        .tag-delivered {
            background: var(--inv-tag-resolved);
            color: var(--inv-tag-resolved-text);
        }

        .tag-resolved .tag-dot,
        .tag-delivered .tag-dot {
