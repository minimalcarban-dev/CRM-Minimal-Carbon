                            ...
                            <select id="diamond_type" name="diamond_type" class="form-control themed-select">
                                ...
                                @foreach ($stoneTypes ?? [] as $stype)
                                    <option value="{{ $stype->name }}"
                                        {{ old('diamond_type') == $stype->name ? 'selected' : '' }}>
                                        {{ $stype->name }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <div class="input-with-icon">
                                ...
                                <select id="shape" name="shape" class="form-control themed-select">
                                    ...
                                    @foreach ($stoneShapes ?? [] as $sshape)
                                        <option value="{{ $sshape->name }}"
                                            {{ old('shape') == $sshape->name ? 'selected' : '' }}>
                                            {{ $sshape->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="input-with-icon">
                                ...
                                <select id="cut" name="cut" class="form-control themed-select">
                                    ...
                                    @foreach ($diamondCuts ?? [] as $dcut)
                                        <option value="{{ $dcut->name }}"
                                            {{ old('cut') == $dcut->name ? 'selected' : '' }}>
                                            {{ $dcut->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <select id="color" name="color" class="form-control themed-select">
                                ...
                                @foreach ($stoneColors ?? [] as $scolor)
                                    <option value="{{ $scolor->name }}"
                                        {{ old('color') == $scolor->name ? 'selected' : '' }}>
                                        {{ $scolor->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select id="clarity" name="clarity" class="form-control themed-select">
                                ...
                                @foreach ($diamondClarities ?? [] as $dclar)
                                    <option value="{{ $dclar->name }}"
                                        {{ old('clarity') == $dclar->name ? 'selected' : '' }}>
                                        {{ $dclar->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" step="0.01" class="form-control" id="per_ct" name="per_ct"
                                    value="{{ old('per_ct') }}" placeholder="Enter in INR">
                            </div>
                            <div class="form-hint">
                                <i class="bi bi-info-circle"></i>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" step="0.01" class="form-control" id="weight" name="weight"
                                    value="{{ old('weight', 0) }}" placeholder="Carats">
                            </div>
                            <div class="form-hint">
                                <i class="bi bi-info-circle"></i>
                                Weight in carats
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" step="0.01" class="form-control" id="margin" name="margin"
                                    value="{{ old('margin') }}" required placeholder="Margin percentage">
                            </div>
                            <div class="form-hint">
                                <i class="bi bi-info-circle"></i>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" step="0.01" class="form-control" id="shipping_price"
                                    name="shipping_price" value="{{ old('shipping_price', 0) }}"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="is_sold_out" name="is_sold_out" disabled>
                                <option value="IN Stock"
                                    {{ old('is_sold_out', 'IN Stock') == 'IN Stock' ? 'selected' : '' }}>IN Stock</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" step="0.01" class="form-control" id="sold_out_price"
                                    name="sold_out_price" value="{{ old('sold_out_price') }}"
                                    placeholder="Enter in INR">
                            </div>
                            <div class="form-hint">
                                <i class="bi bi-info-circle"></i>
                            ...
                            <select class="form-control themed-select" id="current_location" name="current_location">
                                ...
                                @foreach ($countries ?? [] as $country)
                                    <option value="{{ $country }}"
                                        {{ old('current_location', 'India') == $country ? 'selected' : '' }}>
                                        {{ $country }}
                                    </option>
                                @endforeach
                            </select>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                ['input', 'change'].forEach(evt => {
                    const listingPriceEl = document.getElementById('listing_price');
                    const offerCalculationEl = document.getElementById('offer_calculation');
                    [listingPriceEl, offerCalculationEl].forEach(el => el && el.addEventListener(evt,
                        computeActualListingPrice));
                });
                    ...
                    const show = () => {
                        try {
                                ...
                                didOpen: () => {
                                    ...
                                    if (loader) {
                                        loader.style.borderColor =
                                            '#6366f1 transparent #6366f1 transparent';
                                    }
                                }
                            });
                        } catch (e) {
                            ...
                            if (!document.getElementById('__simple_block_loader')) {
                                ...
                                o.style.cssText =
                                    'position:fixed;left:0;top:0;right:0;bottom:0;background:rgba(30,41,59,0.6);z-index:99999;display:flex;align-items:center;justify-content:center;';
                                o.innerHTML = `
