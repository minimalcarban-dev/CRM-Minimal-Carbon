...
@section('content')
    <div class="tracker-page">
            ...
            <div class="header-content">
                ...
                <div class="header-right">
                    <div class="actions-stack">
                        <a href="{{ route('diamond.create') }}" class="btn-primary-custom actions-btn">
                            <i class="bi bi-plus-circle"></i>
                            <span>Add Diamond</span>
                        </a>

                        <div class="actions-row">
                            <form id="importForm" action="{{ route('diamonds.import') }}" method="POST"
            ...
            <div class="stats-grid">
                <div class="stat-card stat-card-primary">
                    ...
                    <div class="stat-content">
                        ...
                        <div class="stat-value">{{ $allDiamondsCount ?? 0 }}</div>
                        <div class="stat-breakdown">
                            <span class="breakdown-item breakdown-success">
                                <i class="bi bi-check-circle"></i> In Stock: {{ $inStockCount ?? 0 }}
                            </span>
                            <span class="breakdown-item breakdown-sold">
                                <i class="bi bi-tag"></i> Sold: {{ $soldCount ?? 0 }}
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="filter-section">
            ...
            <form method="GET" action="{{ route('diamond.index') }}" class="filter-form" id="filterForm">
                <!-- Search Section -->
                    ...
                    <div class="filter-row-4">
                        ...
                        <div class="filter-field">
                            ...
                            <select name="cut" class="filter-select">
                                ...
                                @foreach ($cuts as $cut)
                                    <option value="{{ $cut }}" {{ request('cut') === $cut ? 'selected' : '' }}>
                                        {{ $cut }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <select name="clarity" class="filter-select">
                                ...
                                @foreach ($clarities as $clarity)
                                    <option value="{{ $clarity }}"
                                        {{ request('clarity') === $clarity ? 'selected' : '' }}>
                                        {{ $clarity }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="filter-row-3">
                        ...
                        <div class="filter-field">
                            ...
                            <select name="diamond_type" class="filter-select">
                                ...
                                @foreach ($diamondTypes as $type)
                                    <option value="{{ $type }}"
                                        {{ request('diamond_type') === $type ? 'selected' : '' }}>
                                        {{ $type }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <select name="current_location" class="filter-select">
                                ...
                                @foreach ($countries ?? [] as $country)
                                    <option value="{{ $country }}"
                                        {{ request('current_location') === $country ? 'selected' : '' }}>
                                        {{ $country }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="filter-row-3">
                        <div class="filter-field-range">
                            ...
                            <div class="filter-range-inputs">
                                <input type="number" name="min_price" class="filter-input filter-input-small"
                                    placeholder="Min Price" step="0.01" value="{{ request('min_price') }}">
                                <span class="range-separator">—</span>
                                <input type="number" name="max_price" class="filter-input filter-input-small"
                                    placeholder="Max Price" step="0.01" value="{{ request('max_price') }}">
                            </div>
                        </div>
                        ...
                        <div class="filter-field-range">
                            ...
                            <div class="filter-range-inputs">
                                <input type="number" name="min_weight" class="filter-input filter-input-small"
                                    placeholder="Min Carat" step="0.01" value="{{ request('min_weight') }}">
                                <span class="range-separator">—</span>
                        ...
                        <div class="filter-field-range">
                            ...
                            <div class="date-range-wrapper" style="flex: 1;">
                                ...
                                <input type="hidden" name="date_to" id="diamondDateTo"
                ...
                <div class="filter-actions">
                    <div class="filter-actions-left">
                        <span class="result-count">
                            ...
                            Showing <strong>{{ $diamonds->count() }}</strong> of <strong>{{ $totalDiamonds }}</strong>
                            diamonds
                        </span>
                    ...
                    <div class="filter-actions-right">
                        <a href="{{ route('diamond.index') }}" class="btn-filter-reset">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        @forelse($diamonds as $d)
                            ...
                            <tr class="diamond-row {{ $isSold ? 'sold-row' : '' }}"
                                data-search="{{ strtolower($d->lot_no . ' ' . $d->sku . ' ' . $d->barcode_number) }}">
                                <td>
                                    <div class="cell-content">
                                        <span class="badge-custom badge-primary">{{ $d->lot_no }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="cell-content">
                                ...
                                <td>
                                    <div class="cell-content">
                                        <span class="text-muted">{{ $d->cut ?: '—' }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="cell-content">
                                ...
                                <td>
                                    <div class="cell-content">
                                        <span class="text-muted">{{ $d->weight ? $d->weight . ' ct' : '—' }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="cell-content">
                                ...
                                <td>
                                    <div class="cell-content">
                                        <span
                                            class="price-value listing">${{ number_format($d->listing_price, 2) }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="cell-content">
                                    ...
                                    <div class="cell-content">
                                        <div class="admin-assignment">
                                            ...
                                            <button type="button" class="btn-reassign"
                                                data-diamond-id="{{ $d->id }}" title="Reassign to another admin">
                                ...
                                <td>
                                    <div class="cell-content cell-content-center">
                                        <div class="action-buttons">
                                            ...
                                            @if (auth()->guard('admin')->user() &&
                                                    auth()->guard('admin')->user()->canAccessAny(['diamonds.edit']))
                                                <a href="{{ route('diamond.edit', $d) }}"
                                            ...
                                            @if (
                                                $sold &&
                                                    ...
                                                    auth()->guard('admin')->user()->canAccessAny(['diamonds.edit']))
                                                <form action="{{ route('diamond.restock', $d) }}" method="POST"
                                                    class="d-inline restock-form">
                                                    @csrf
                                                    <button type="button"
                                                        class="action-btn action-btn-restock restock-btn" title="Restock"
                                                        data-diamond-id="{{ $d->id }}"
                                                        data-diamond-sku="{{ $d->sku }}">
                                                        <i class="bi bi-arrow-counterclockwise"></i>
                                                    </button>
                                                </form>
                                            @endif
                                            ...
                                            @if (auth()->guard('admin')->user() &&
                                                    auth()->guard('admin')->user()->canAccessAny(['diamonds.delete']))
                                                <form action="{{ route('diamond.destroy', $d) }}" method="POST"
                            ...
                            <tr>
                                <td colspan="10">
                                    <div class="empty-state-inline">
                                        ...
                                        <p class="empty-description">Start by adding your first diamond to the inventory
                                        </p>
            ...
            <div class="tutorial-modal-body">
                <div class="tutorial-step">
                    ...
                    <div class="step-content">
                        ...
                        <a href="{{ asset('uploads/diamonds_import_sample.csv') }}" class="btn-download" download>
    ...
    <div id="exportModal" class="modal-overlay d-none">
        <div class="tutorial-modal">
            ...
            <div class="tutorial-modal-footer">
                ...
                <a href="{{ route('diamonds.export', request()->query()) }}" class="btn-modal btn-modal-success"
                    id="proceedExport">
    ...
    {{-- Bulk Edit Modal --}}
    @include('diamonds.partials._bulk-edit-modal')

    {{-- Bulk Edit CSS --}}
    <link rel="stylesheet" href="{{ asset('css/bulk-edit.css') }}">
