                    ...
                    <div class="filter-field">
                        ...
                        <select name="shape" class="filter-select">
                            ...
                            @foreach($shapes as $shape)
                                <option value="{{ $shape }}" {{ request('shape') === $shape ? 'selected' : '' }}>
                                    {{ $shape }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="filter-field">
                        ...
                        <select name="clarity" class="filter-select">
                            ...
                            @foreach($clarities as $clarity)
                                <option value="{{ $clarity }}" {{ request('clarity') === $clarity ? 'selected' : '' }}>
                                    {{ $clarity }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="filter-field">
                        ...
                        <select name="diamond_type" class="filter-select">
                            ...
                            @foreach($diamondTypes as $type)
                                <option value="{{ $type }}" {{ request('diamond_type') === $type ? 'selected' : '' }}>
                                    {{ $type }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <td>
                            <div class="cell-content cell-content-center">
                                <div class="action-buttons">
                                    ...
                                    @if (auth()->guard('admin')->user() && auth()->guard('admin')->user()->canAccessAny(['diamonds.edit']))
                                    ...
                                    @if ($sold && auth()->guard('admin')->user() && auth()->guard('admin')->user()->canAccessAny(['diamonds.edit']))
                                        <form action="{{ route('diamond.restock', $d) }}" method="POST"
                                            ...
                                            <button type="button" class="action-btn action-btn-restock restock-btn"
                                                title="Restock" data-diamond-id="{{ $d->id }}"
                                    ...
                                    @if (auth()->guard('admin')->user() && auth()->guard('admin')->user()->canAccessAny(['diamonds.delete']))
