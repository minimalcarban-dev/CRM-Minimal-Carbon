...
@section('title', 'Create Diamond Cut')
    ...
    <div class="attr-form-container">
        <div class="attr-page-header">
            <div class="attr-header-content">
                <div class="attr-header-left">
                    ...
                    <h1 class="attr-page-title"><i class="bi bi-plus-circle"></i> Create Diamond Cut</h1>
                    <p class="attr-page-subtitle">Add a new diamond cut to your inventory</p>
                </div>
        ...
        <div class="attr-form-card">
            <div class="attr-form-card-header">
                <div class="attr-form-card-icon"><i class="bi bi-scissors"></i></div>
                <div class="attr-form-card-title">
                    <h2>Diamond Cut Details</h2>
                    <p>Enter the information for the new diamond cut</p>
                </div>
            </div>
            <div class="attr-form-card-body">
                <form method="POST" action="{{ route('diamond_cuts.store') }}">
                    @csrf
                    <div class="attr-form-group">
                        ...
                        <input type="text" name="name" class="attr-form-input @error('name') is-invalid @enderror"
                            value="{{ old('name') }}" placeholder="e.g., Excellent, Very Good, Good" required autofocus>
                    ...
                    <div class="attr-form-actions">
                        <a href="{{ route('diamond_cuts.index') }}" class="attr-btn-cancel"><i class="bi bi-x-circle"></i>
                            Cancel</a>
