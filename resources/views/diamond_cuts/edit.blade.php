...
@section('title', 'Edit Diamond Cut')
        ...
        <div class="attr-page-header">
            <div class="attr-header-content">
                <div class="attr-header-left">
                    ...
                    <h1 class="attr-page-title"><i class="bi bi-pencil-square"></i> Edit Diamond Cut</h1>
                    <p class="attr-page-subtitle">Update diamond cut information</p>
                </div>
        ...
        <div class="attr-form-card">
            <div class="attr-form-card-header">
                ...
                <div class="attr-form-card-title">
                    ...
                    <p>Update the diamond cut information</p>
                </div>
            </div>
            <div class="attr-form-card-body">
                <form method="POST" action="{{ route('diamond_cuts.update', $item->id) }}">
                    @csrf
                    @method('PUT')
