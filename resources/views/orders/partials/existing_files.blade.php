                ...
                @if(!empty($url))
                    <div class="od-img-item" id="img-{{ $index }}">
                        ...
                        <button type="button" class="remove-existing-file"
                            onclick="removeExistingFile('{{ $url }}', 'image', 'img-{{ $index }}', event)" title="Remove Image">
                            <i class="bi bi-x"></i>
                        </button>
                    </div>
                @endif
            ...
            @foreach($pdfs as $index => $pdf)
                ...
                @if(!empty($pdfPath))
                    <div class="od-pdf-item" id="pdf-{{ $index }}">
                        ...
                        <div class="od-pdf-info" style="cursor: pointer;"
                            onclick="viewPDF('{{ $pdfFullUrl }}', '{{ str_replace("'", "\\'", $pdfName) }}')">
                        ...
                        <div class="od-pdf-actions">
                            <button type="button" class="od-pdf-btn" title="View"
                                onclick="viewPDF('{{ $pdfFullUrl }}', '{{ str_replace("'", "\\'", $pdfName) }}')">
                                <i class="bi bi-eye"></i>
                            </button>
                            <button type="button" class="od-pdf-btn" title="Download"
                                onclick="downloadPDF('{{ $pdfFullUrl }}', '{{ str_replace("'", "\\'", $pdfName) }}')">
