            ...
            <div class="col-md-6">
                <div class="form-group-modern">
                    ...
                    <select name="gold_detail_id" class="form-control-modern">
                        ...
                        @foreach(App\Models\MetalType::all() as $metal)
            ...
            <div class="col-md-6">
                <div class="form-group-modern">
                    ...
                    <select name="ring_size_id" class="form-control-modern">
                        ...
                        @foreach(App\Models\RingSize::all() as $size)
            ...
            <div class="col-md-6">
                <div class="form-group-modern">
                    ...
                    <select name="setting_type_id" class="form-control-modern">
                        ...
                        @foreach(App\Models\SettingType::all() as $setting)
            ...
            <div class="col-md-6">
                <div class="form-group-modern">
                    ...
                    <select name="earring_type_id" class="form-control-modern">
                        ...
                        @foreach(App\Models\ClosureType::all() as $earring)
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="form-group-modern">
                    ...
                    <input type="number" step="0.01" name="gross_sell" class="form-control-modern" placeholder="0.00"
                        value="{{ old('gross_sell', $order->gross_sell ?? '') }}">
                    <div class="form-hint">
                        <i class="bi bi-info-circle"></i>
            ...
            <div class="col-md-6">
                <div class="form-group-modern">
                    ...
                    <textarea name="note" class="form-control-modern" rows="3"
                        placeholder="Enter any additional notes or comments...">{{ old('note', $order->note ?? '') }}</textarea>
                </div>
            </div>
        </div>
    </div>
...
<div class="form-section-card mb-4">
    ...
    <div class="section-body">
        <div class="file-upload-wrapper">
            ...
            <label for="product_images" class="file-upload-area">
        ...
        <div class="file-upload-wrapper">
            ...
            <input type="file" name="order_pdfs[]" id="order_pdfs" class="file-input-hidden" accept="application/pdf"
                multiple>
            <label for="order_pdfs" class="file-upload-area">
                <div class="file-upload-content">
