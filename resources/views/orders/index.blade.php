...
@section('content')
    ...
    <style>
        ...
        * {
        ...
        /*
                                                                                                 * PILL DESIGN PHILOSOPHY:
                                                                                                 * - White/rgba background so it "floats" above any row color (white or pink overdue)
                                                                                                 * - A bold colored left-side dot/stripe gives instant color meaning
                                                                                                 * - Border matches the accent color at low opacity — visible on both backgrounds
                                                                                                 * - Text is always the dark accent shade — readable everywhere
                                                                                                 */
