    ...
    <div class="attr-form-container">
            ...
            <div class="attr-header-content">
                <div class="attr-header-left">
                    <div class="attr-breadcrumb-nav">
                        ...
                        <a href="{{ route('setting_types.index') }}" class="attr-breadcrumb-link">Setting Types</a>
                        <i class="bi bi-chevron-right attr-breadcrumb-separator"></i>
                        <span class="attr-breadcrumb-current">Create</span>
                    </div>
                    <h1 class="attr-page-title"><i class="bi bi-plus-circle"></i> Create Setting Type</h1>
                    <p class="attr-page-subtitle">Add a new setting type to your inventory</p>
                </div>
                <div class="attr-header-right">
                    <a href="{{ route('setting_types.index') }}" class="attr-btn-back"><i class="bi bi-arrow-left"></i> Back
                        to List</a>
                </div>
            </div>
        </div>
        ...
        <div class="attr-form-card">
            <div class="attr-form-card-header">
                <div class="attr-form-card-icon"><i class="bi bi-sliders"></i></div>
                <div class="attr-form-card-title">
                    <h2>Setting Type Details</h2>
                    <p>Enter the information for the new setting type</p>
                </div>
            </div>
            <div class="attr-form-card-body">
                <form method="POST" action="{{ route('setting_types.store') }}">
                    @csrf
                    <div class="attr-form-group">
                        ...
                        <input type="text" name="name" class="attr-form-input @error('name') is-invalid @enderror"
                            value="{{ old('name') }}" placeholder="e.g., Prong, Bezel, Channel" required autofocus>
                    ...
                    <div class="attr-form-actions">
                        <a href="{{ route('setting_types.index') }}" class="attr-btn-cancel"><i class="bi bi-x-circle"></i>
                            Cancel</a>
                        <button type="submit" class="attr-btn-submit"><i class="bi bi-check-circle"></i> Create Setting
                            Type</button>
                    </div>
                </form>
            </div>
