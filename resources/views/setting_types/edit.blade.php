        ...
        <div class="attr-page-header">
            <div class="attr-header-content">
                <div class="attr-header-left">
                    ...
                    <h1 class="attr-page-title"><i class="bi bi-pencil-square"></i> Edit Setting Type</h1>
                    <p class="attr-page-subtitle">Update setting type information</p>
                </div>
        ...
        <div class="attr-form-card">
            <div class="attr-form-card-header">
                ...
                <div class="attr-form-card-title">
                    ...
                    <p>Update the setting type information</p>
                </div>
            </div>
            <div class="attr-form-card-body">
                <form method="POST" action="{{ route('setting_types.update', $item->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="attr-form-actions">
                        <a href="{{ route('setting_types.index') }}" class="attr-btn-cancel"><i class="bi bi-x-circle"></i>
                            Cancel</a>
                        <button type="submit" class="attr-btn-submit"><i class="bi bi-check-circle"></i> Update Setting
                            Type</button>
                    </div>
                </form>
            </div>
