...
<head>
    ...
    <style>
        body { font-family: system-ui, sans-serif; background-color: #f4f7f9; color: #333; padding: 2rem; }
        ...
        .status-connecting { background-color: #e0f2fe; color: #0c5460; }
        .status-connected { background-color: #d4edda; color: #155724; }
        .status-error { background-color: #f8d7da; color: #721c24; }
        #messages { list-style: none; padding: 0; margin-top: 1rem; background: #2d3748; color: #f7fafc; padding: 1rem; border-radius: 6px; height: 300px; overflow-y: auto; }
        #messages li { padding: 0.5rem 0; border-bottom: 1px solid #4a5568; }
        #messages li:last-child { border-bottom: none; }
        button { background-color: #4299e1; color: white; padding: 0.75rem 1.5rem; border: none; border-radius: 6px; cursor: pointer; font-size: 1rem; margin-top: 1rem; }
