                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" class="form-control themed-select @error('type') is-invalid @enderror"
                                ...
                                <option value="ring" {{ old('type', $jewelleryStock->type) == 'ring' ? 'selected' : '' }}>
                                    Ring</option>
                                <option value="earrings"
                                    {{ old('type', $jewelleryStock->type) == 'earrings' ? 'selected' : '' }}>Earrings
                                </option>
                                <option value="tennis_bracelet"
                                    {{ old('type', $jewelleryStock->type) == 'tennis_bracelet' ? 'selected' : '' }}>Tennis
                                    Bracelet</option>
                                <option value="other"
                                    {{ old('type', $jewelleryStock->type) == 'other' ? 'selected' : '' }}>Other</option>
                            </select>
                            @error('type')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group full-width">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                placeholder="e.g. 18K Gold Solitaire Ring" value="{{ old('name', $jewelleryStock->name) }}"
                                required>
                            @error('name')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" name="weight"
                                    ...
                                    step="0.001" min="0" value="{{ old('weight', $jewelleryStock->weight) }}">
                            </div>
                            @error('weight')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                ...
                <div class="section-header">
                    <div class="section-info">
                        ...
                        <div>
                            ...
                            <p class="section-description">Adjust quantity and low stock alert threshold</p>
                        </div>
                    </div>
                </div>
                <div class="section-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" name="quantity"
                                    ...
                                    min="0" value="{{ old('quantity', $jewelleryStock->quantity) }}" required>
                            </div>
                            @error('quantity')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                ...
                <div class="section-header">
                    <div class="section-info">
                        ...
                        <div>
                            ...
                            <p class="section-description">Update purchase and selling prices</p>
                        </div>
                    </div>
                </div>
                <div class="section-body">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <div class="d-flex gap-4 mb-3">
                                <div class="form-check custom-radio">
                                    <input class="form-check-input" type="radio" name="image_source_type"
                                        id="image_source_upload" value="upload"
                                        {{ !old('image_url', $jewelleryStock->image_url) ? 'checked' : '' }}
                            ...
                            <div id="image_upload_section"
                                style="display: {{ !old('image_url', $jewelleryStock->image_url) ? 'block' : 'none' }};">
                                <div class="input-with-icon">
                            ...
                            <div id="image_url_section"
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="url" name="image_url" id="image_url"
                                        ...
                                        value="{{ old('image_url', $jewelleryStock->image_url) }}"
                            ...
                            <div class="mt-3 image-preview-container"
                                ...
                                <img id="image_preview" src="{{ old('image_url', $jewelleryStock->image_url) }}"
    ...
    <script>
        function toggleImageSource(type) {
            if (type === 'upload') {
                ...
                // Optional: You could clear the URL here, but for edits it might be nice to retain it 
                // incase they switch back before submitting. Let's just hide the error.
        ...
        document.addEventListener('DOMContentLoaded', function() {
            if (document.getElementById('image_source_url').checked) {
                ...
                // If there is an initial URL, trigger preview just in case to handle any loading errors seamlessly
