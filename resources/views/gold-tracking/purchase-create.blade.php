...
@section('content')
    <div class="diamond-management-container tracker-page">
        ...
        <form id="goldPurchaseForm" action="{{ route('gold-tracking.purchases.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
    ...
    @push('scripts')
        ...
        <script>
            (function () {
                ...
                const purchaseForm = document.getElementById('goldPurchaseForm');
                ...
                let hasManualRateOverride = false;
