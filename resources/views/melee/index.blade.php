...
@section('content')
    ...
    <div class="inventory-management-container">
        @include('melee.partials._page_header')

        @include('melee.partials._stats_cards')

        <!-- Main Content Card -->
        <div class="inventory-card">

            @include('melee.partials._category_sidebar')

            @include('melee.partials._diamond_panel')
    ...
    @include('melee.partials._modal_history')

    @include('melee.partials._modal_quick_order')

    @include('melee.partials._modal_edit_melee')
    @include('melee.partials._modal_edit_transaction')
