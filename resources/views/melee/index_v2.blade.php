...
@section('title', 'Melee Diamond Inventory (V2)')
...
@section('content')
    ...
    <div class="inventory-management-container">
        ...
        <div class="page-header">
            <div>
                <h2 class="mb-1 fw-bold text-dark"><i class="bi bi-gem me-2 text-primary"></i>Melee Inventory V2</h2>
                <div class="text-secondary small">Manage stock with new split-view layout</div>
            </div>
                                ...
                                <tbody>
                                    @foreach($category->diamonds as $diamond)
                                        <tr class="searchable-row" data-search="{{ strtolower($diamond->size_label . ' ' . $diamond->shape) }}">
                                            ...
                                            <td class="fw-medium">${{ number_format($diamond->purchase_price_per_ct, 2) }}</td>
                                            <td class="text-end">
    ...
    <script>
        ...
        function openTransactionModal(type, diamondId, diamondName, categoryName) {
            ...
            if (type === 'in') {
                ...
                // updateModalTheme('in'); // Assuming this function is global or in partial
            } else {
