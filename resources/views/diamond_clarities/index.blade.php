    ...
    <div class="attr-list-container">
        <div class="attr-list-header">
            <div class="attr-header-content">
                ...
                @if ($currentAdmin && $currentAdmin->hasPermission('diamond_clarities.create'))
                    <div class="attr-header-right">
                        <a href="{{ route('diamond_clarities.create') }}" class="attr-btn-create"><i
        ...
        <div class="attr-filter-section">
            <form method="GET" class="attr-filter-form">
                ...
                @if(request('search'))<a href="{{ route('diamond_clarities.index') }}" class="attr-btn-reset"><i
        ...
        <div class="attr-table-card">
                        ...
                        @foreach ($items as $item)
                            <tr class="attr-row">
                                ...
                                <td class="attr-actions">
                                    @if ($currentAdmin && $currentAdmin->hasPermission('diamond_clarities.view'))<a
                                        href="{{ route('diamond_clarities.show', $item->id) }}" class="attr-action-btn view"><i
                                    class="bi bi-eye"></i></a>@endif
                                    @if ($currentAdmin && $currentAdmin->hasPermission('diamond_clarities.edit'))<a
                                        href="{{ route('diamond_clarities.edit', $item->id) }}" class="attr-action-btn edit"><i
                                    class="bi bi-pencil"></i></a>@endif
                                    @if ($currentAdmin && $currentAdmin->hasPermission('diamond_clarities.delete'))
                                        <form action="{{ route('diamond_clarities.destroy', $item->id) }}" method="POST"
            ...
            @else
                <div class="attr-empty-state">
                    ...
                    <p>Get started by adding your first diamond clarity.</p><a href="{{ route('diamond_clarities.create') }}"
