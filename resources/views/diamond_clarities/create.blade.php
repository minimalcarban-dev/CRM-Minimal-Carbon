...
@section('title', 'Create Diamond Clarity')
    ...
    <div class="attr-form-container">
            ...
            <div class="attr-header-content">
                <div class="attr-header-left">
                    <div class="attr-breadcrumb-nav">
                        ...
                        <a href="{{ route('diamond_clarities.index') }}" class="attr-breadcrumb-link">Diamond Clarities</a>
                        <i class="bi bi-chevron-right attr-breadcrumb-separator"></i>
                        <span class="attr-breadcrumb-current">Create</span>
                    </div>
                    <h1 class="attr-page-title"><i class="bi bi-plus-circle"></i> Create Diamond Clarity</h1>
                    <p class="attr-page-subtitle">Add a new diamond clarity to your inventory</p>
                </div>
                <div class="attr-header-right">
                    <a href="{{ route('diamond_clarities.index') }}" class="attr-btn-back"><i class="bi bi-arrow-left"></i>
                        Back to List</a>
                </div>
            </div>
        </div>
        ...
        <div class="attr-form-card">
            <div class="attr-form-card-header">
                <div class="attr-form-card-icon"><i class="bi bi-eye"></i></div>
                <div class="attr-form-card-title">
                    <h2>Diamond Clarity Details</h2>
                    <p>Enter the information for the new diamond clarity</p>
                </div>
            </div>
            <div class="attr-form-card-body">
                <form method="POST" action="{{ route('diamond_clarities.store') }}">
                    @csrf
                    <div class="attr-form-group">
                        ...
                        <input type="text" name="name" class="attr-form-input @error('name') is-invalid @enderror"
                            value="{{ old('name') }}" placeholder="e.g., IF, VVS1, VVS2, VS1, VS2" required autofocus>
                    ...
                    <div class="attr-form-actions">
                        <a href="{{ route('diamond_clarities.index') }}" class="attr-btn-cancel"><i
                                class="bi bi-x-circle"></i> Cancel</a>
                        <button type="submit" class="attr-btn-submit"><i class="bi bi-check-circle"></i> Create Diamond
                            Clarity</button>
                    </div>
                </form>
            </div>
