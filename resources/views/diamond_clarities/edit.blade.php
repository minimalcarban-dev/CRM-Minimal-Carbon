...
@section('title', 'Edit Diamond Clarity')
        ...
        <div class="attr-page-header">
            <div class="attr-header-content">
                <div class="attr-header-left">
                    ...
                    <h1 class="attr-page-title"><i class="bi bi-pencil-square"></i> Edit Diamond Clarity</h1>
                    <p class="attr-page-subtitle">Update diamond clarity information</p>
                </div>
        ...
        <div class="attr-form-card">
            <div class="attr-form-card-header">
                ...
                <div class="attr-form-card-title">
                    ...
                    <p>Update the diamond clarity information</p>
                </div>
            </div>
            <div class="attr-form-card-body">
                <form method="POST" action="{{ route('diamond_clarities.update', $item->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="attr-form-actions">
                        ...
                        <button type="submit" class="attr-btn-submit"><i class="bi bi-check-circle"></i> Update Diamond
                            Clarity</button>
                    </div>
                </form>
            </div>
