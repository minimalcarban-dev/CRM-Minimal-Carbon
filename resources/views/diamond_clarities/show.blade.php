...
@section('title', 'View Diamond Clarity')
        ...
        <div class="attr-page-header">
            <div class="attr-header-content">
                <div class="attr-header-left">
                    ...
                    <h1 class="attr-page-title"><i class="bi bi-eye"></i> Diamond Clarity Details</h1>
                    <p class="attr-page-subtitle">View diamond clarity information</p>
                </div>
        ...
        <div class="attr-detail-card">
            <div class="attr-detail-header">
                <div class="attr-detail-info">
                    <div class="attr-detail-icon"><i class="bi bi-eye"></i></div>
                    <div class="attr-detail-title">
                        <h2>{{ $item->name }}</h2>
                        <p>Diamond Clarity Information</p>
                    </div>
                </div>
            ...
            <div class="attr-detail-body">
                ...
                <div class="attr-detail-actions">
                    <a href="{{ route('diamond_clarities.edit', $item->id) }}" class="attr-btn-edit"><i
                            class="bi bi-pencil"></i> Edit</a>
                    <form action="{{ route('diamond_clarities.destroy', $item->id) }}" method="POST" style="display:inline;"
