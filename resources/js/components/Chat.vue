    ...
    <div class="chat-container">
        ...
        <div class="chat-main" v-if="currentChannel">
            ...
            <div class="chat-header">
                ...
                <div class="header-actions">
                    ...
                    <button
                        v-if="currentChannel.can_manage_members"
        ...
        <div class="info-sidebar" v-if="currentChannel && showSidebar">
            ...
            <div class="info-sections">
                <!-- About Section (only shown for group channels and personal chats for super admins) -->
                <div v-if="showSidebar" class="info-section">
                    ...
                    <div v-show="openPanel === 'info'" class="section-content">
                        ...
                        <div class="info-item">
                            ...
                            <strong>
                                <p>
                                    {{ formatFullDate(channelInfo.created_at) }}
                                </p>
                            </strong>
                        </div>
                    </div>
                ...
                <!-- Members Section (only shown for group channels and personal chats for super admins) -->
                <div v-if="showSidebar" class="info-section">
                    <button
    ...
    setup(props) {
        ...
        const loadChannels = async () => {
            try {
                ...
                window.showAlert?.("Failed to load channels", "error");
            }
        };
        ...
        const loadMessages = async (channelId, reset = false) => {
            ...
            try {
                ...
                if (error?.response?.status === 403) {
                    ...
                    window.showAlert?.("Failed to load messages", "error");
                }
                return false;
            } finally {
        ...
        const loadSidebar = async (channelId) => {
            ...
            try {
                ...
                window.showAlert?.("Failed to load sidebar details", "error");
                channelInfo.value = {
                    creator: null,
                    members: [],
                    created_at: null,
        ...
        const debounceSearch = debounce(async () => {
            ...
            try {
                ...
                window.showAlert?.("Message search failed", "error");
            } finally {
                isSearching.value = false;
            }
        }, 300);
        ...
        const openManageMembers = async () => {
            ...
            try {
                ...
                window.showAlert?.("Failed to load members", "error");
        ...
        const saveMembers = async () => {
            ...
            try {
                ...
                window.showAlert?.("Failed to update members", "error");
            }
        };
        ...
        const saveCreateChannel = async () => {
            ...
            try {
                ...
                window.showAlert?.("Failed to create channel", "error");
            }
        };
        ...
        onMounted(() => {
            ...
            try {
                const notificationChannel = Echo.private(
