...
<?php $__env->startSection('content'); ?>
    <div class="permission-management-container">
        ...
        <div class="page-header">
            <div class="header-content">
                ...
                <div class="header-right">
                    <?php if(isset($currentAdmin) && ($currentAdmin->is_super || $currentAdmin->hasPermission('permissions.create'))): ?>
                        <a href="<?php echo e(route('permissions.create')); ?>" class="btn-primary-custom">
        ...
        <div class="stats-grid">
            <div class="stat-card stat-card-primary">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-value"><?php echo e($totalPermissions); ?></div>
            ...
            <div class="stat-card stat-card-info">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-value"><?php echo e($allActionsPresent->count()); ?></div>
                    <div class="stat-trend">
            ...
            <div class="filter-controls">
                ...
                <div class="filter-group">
                    <select id="perm-module" class="filter-select">
                        ...
                        <?php $__currentLoopData = $grouped->keys(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($module); ?>"><?php echo e(humanize_module($module)); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>

                    <select id="perm-action" class="filter-select">
                        <option value="">All Actions</option>
                        <?php $__currentLoopData = $actionOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($action); ?>"><?php echo e(ucfirst(str_replace('_', ' ', $action))); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
        ...
        <div class="modules-container">
            <?php $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module => $permissionsGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="module-card permission-section" data-module="<?php echo e($module); ?>">
                    <div class="module-header" onclick="toggleModule('<?php echo e($moduleId); ?>')">
                        <div class="module-info">
                            ...
                            <span class="module-count"><?php echo e($permissionsGroup->count()); ?> permissions</span>
                        </div>

                        <div class="module-actions">
                            <div class="action-badges">
                                <?php $__currentLoopData = $presentActions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="action-badge action-<?php echo e($act); ?>">
                                        <i class="bi <?php echo e($iconMap[$act] ?? 'bi-circle-fill'); ?>"></i>
                                        <?php echo e(ucfirst(str_replace('_', ' ', $act))); ?>

                                    </span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            <i class="bi bi-chevron-down collapse-icon" id="icon-<?php echo e($moduleId); ?>"></i>
                        </div>
                    </div>

                    <div id="module-<?php echo e($moduleId); ?>" class="module-body" style="display: block;">
                        <div class="permissions-grid">
                            <?php $__currentLoopData = $permissionsGroup->sortBy('slug'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="permission-card perm-item" data-module="<?php echo e($module); ?>" data-action="<?php echo e($action); ?>">
                                    <div class="permission-header">
                                        <div class="permission-badge badge-<?php echo e($action); ?>">
                                            <i class="bi <?php echo e($iconMap[$action] ?? 'bi-circle-fill'); ?>"></i>
                                        </div>
                                        <div class="permission-actions">
                                            <?php if($currentAdmin->is_super || $currentAdmin->hasPermission('permissions.view')): ?>
                                                <a href="<?php echo e(route('permissions.show', $perm)); ?>" class="action-btn action-btn-view"
                                                    title="View">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                            <?php endif; ?>
                                            <?php if($currentAdmin->is_super || $currentAdmin->hasPermission('permissions.edit')): ?>
                                                <a href="<?php echo e(route('permissions.edit', $perm)); ?>" class="action-btn action-btn-edit"
                                                    title="Edit">
                                                    <i class="bi bi-pencil"></i>
                                                </a>
                                            <?php endif; ?>
                                            <?php if($currentAdmin->is_super || $currentAdmin->hasPermission('permissions.delete')): ?>
                                                <form action="<?php echo e(route('permissions.delete', $perm)); ?>" method="POST" class="d-inline"
                                                    class="delete-form">
                                    ...
                                    <div class="permission-content">
                                        <h4 class="permission-name"><?php echo e($perm->name); ?></h4>
                                        <?php if(!empty($perm->description)): ?>
                                            <p class="permission-description"><?php echo e($perm->description); ?></p>
                                        <?php endif; ?>
                                        <div class="permission-meta">
                                            <code class="permission-slug" onclick="copySlug('<?php echo e($perm->slug); ?>', this)">
                                                                        <i class="bi bi-code-slash"></i>
                                                                        <?php echo e($perm->slug); ?>

                                                                    </code>
                                            <span class="permission-type"><?php echo e(ucfirst(str_replace('_', ' ', $action))); ?></span>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CRM-Minimal-Carbon\CRM-Minimal-Carbon\resources\views/permissions/index.blade.php ENDPATH**/ ?>