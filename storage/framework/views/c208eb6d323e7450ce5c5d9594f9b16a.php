...
<?php $__env->startSection('title', 'Edit Diamond'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="diamond-management-container">
            ...
            <div class="header-content">
                <div class="header-left">
                    <div class="breadcrumb-nav">
                        ...
                        <a href="<?php echo e(route('diamond.index')); ?>" class="breadcrumb-link">
                            Diamonds
                        </a>
                        <i class="bi bi-chevron-right breadcrumb-separator"></i>
                        <span class="breadcrumb-current">Edit Diamond #<?php echo e($diamond->lot_no); ?></span>
                    </div>
                    <h1 class="page-title">
                        <i class="bi bi-pencil-square"></i>
                        Edit Diamond
                    </h1>
                    <p class="page-subtitle">Update the diamond information below (SKU: <?php echo e($diamond->sku); ?>)</p>
                </div>
                <div class="header-right">
                    <a href="<?php echo e(route('diamond.index')); ?>" class="btn-secondary-custom">
        ...
        <form action="<?php echo e(route('diamond.update', $diamond)); ?>" method="POST" id="diamondForm" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="lot_no" name="lot_no"
                                value="<?php echo e(old('lot_no', $diamond->lot_no)); ?>" placeholder="e.g., L0010078" required>
                            <div class="form-hint">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="sku" name="sku"
                                value="<?php echo e(old('sku', $diamond->sku)); ?>" required>
                            <div class="form-hint">
                                <i class="bi bi-info-circle"></i>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="diamond_type" name="diamond_type"
                                value="<?php echo e(old('diamond_type', $diamond->diamond_type)); ?>"
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <select id="shape" name="shape" class="form-control themed-select">
                                    ...
                                    <?php $__currentLoopData = ($stoneShapes ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sshape): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($sshape->name); ?>" <?php echo e(old('shape', $diamond->shape) == $sshape->name ? 'selected' : ''); ?>>
                                            <?php echo e($sshape->name); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <select id="cut" name="cut" class="form-control themed-select">
                                    ...
                                    <?php $__currentLoopData = ($diamondCuts ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dcut): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($dcut->name); ?>" <?php echo e(old('cut', $diamond->cut) == $dcut->name ? 'selected' : ''); ?>>
                                            <?php echo e($dcut->name); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select id="color" name="color" class="form-control themed-select">
                                ...
                                <?php $__currentLoopData = ($stoneColors ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scolor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($scolor->name); ?>" <?php echo e(old('color', $diamond->color) == $scolor->name ? 'selected' : ''); ?>>
                                        <?php echo e($scolor->name); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select id="clarity" name="clarity" class="form-control themed-select">
                                ...
                                <?php $__currentLoopData = ($diamondClarities ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dclar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($dclar->name); ?>" <?php echo e(old('clarity', $diamond->clarity) == $dclar->name ? 'selected' : ''); ?>>
                                        <?php echo e($dclar->name); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="text" class="form-control" id="measurement" name="measurement"
                                    value="<?php echo e(old('measurement', $diamond->measurement)); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" step="0.01" class="form-control" id="per_ct" name="per_ct"
                                    value="<?php echo e(old('per_ct', $diamond->per_ct)); ?>">
                            </div>
                            <div class="form-hint">
                                <i class="bi bi-info-circle"></i>
                                Price per carat
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" step="0.01" class="form-control" id="weight" name="weight"
                                    value="<?php echo e(old('weight', $diamond->weight)); ?>" placeholder="Carats">
                            </div>
                            <div class="form-hint">
                                <i class="bi bi-info-circle"></i>
                                Weight in carats
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" step="0.01" class="form-control" id="purchase_price"
                                    name="purchase_price" value="<?php echo e(old('purchase_price', $diamond->purchase_price)); ?>"
                                    readonly>
                            </div>
                            <div class="form-hint">
                                <i class="bi bi-info-circle"></i>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" step="0.01" class="form-control" id="margin" name="margin"
                                    value="<?php echo e(old('margin', $diamond->margin)); ?>" required placeholder="Margin percentage">
                            </div>
                            <div class="form-hint">
                                <i class="bi bi-info-circle"></i>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" step="0.01" class="form-control" id="listing_price"
                                    name="listing_price" value="<?php echo e(old('listing_price', $diamond->listing_price)); ?>">
                            </div>
                            <div class="form-hint">
                                <i class="bi bi-info-circle"></i>
                                Final selling price
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" step="0.01" min="0" max="100" class="form-control"
                                    ...
                                    value="<?php echo e(old('offer_calculation', $diamond->offer_calculation)); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" step="0.01" class="form-control" id="actual_listing_price"
                                    ...
                                    value="<?php echo e(old('actual_listing_price', $diamond->actual_listing_price)); ?>" readonly>
                            </div>
                            <div class="form-hint">
                                <i class="bi bi-info-circle"></i>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" step="0.01" class="form-control" id="shipping_price"
                                    name="shipping_price" value="<?php echo e(old('shipping_price', $diamond->shipping_price)); ?>">
                            </div>
                            <div class="form-hint">
                                <i class="bi bi-info-circle"></i>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="purchase_date" name="purchase_date"
                                value="<?php echo e(old('purchase_date', $diamond->purchase_date_formatted)); ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="sold_out_date" name="sold_out_date"
                                value="<?php echo e(old('sold_out_date', $diamond->sold_out_date_formatted)); ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="duration_days" name="duration_days"
                                value="<?php echo e(old('duration_days', $diamond->duration_days)); ?>" readonly>
                            <div class="form-hint">
                                <i class="bi bi-info-circle"></i>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="duration_price" name="duration_price"
                                value="<?php echo e(old('duration_price', $diamond->duration_price)); ?>" readonly>
                            <div class="form-hint">
                                <i class="bi bi-info-circle"></i>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="sold_out_price" name="sold_out_price"
                                value="<?php echo e(old('sold_out_price', $diamond->sold_out_price)); ?>">
                        </div>

                        <div class="form-group">
                            <label for="profit" class="form-label">Profit</label>
                            <input type="number" step="0.01" class="form-control" id="profit" name="profit"
                                value="<?php echo e(old('profit', $diamond->profit)); ?>" readonly>
                            <div class="form-hint">
                                <i class="bi bi-info-circle"></i>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="sold_out_month" name="sold_out_month"
                                value="<?php echo e(old('sold_out_month', $diamond->sold_out_month)); ?>" readonly
                                placeholder="YYYY-MM">
                        </div>
                    </div>
                </div>
                ...
                <div class="section-body">
                    <div class="form-grid">
                        <div class="form-group full-width">
                            ...
                            <?php if($diamond->multi_img_upload && is_array($diamond->multi_img_upload)): ?>
                                <div style="margin-top: 12px;">
                                    <p class="text-semibold" style="margin-bottom: 8px;">Existing Images:</p>
                                    <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                                        <?php $__currentLoopData = $diamond->multi_img_upload; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <img src="<?php echo e($img); ?>" alt="Diamond image"
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea class="form-control" id="description" name="description"
                                rows="3"><?php echo e(old('description', $diamond->description)); ?></textarea>
                        </div>

                        <div class="form-group full-width">
                            <label for="note" class="form-label">Note</label>
                            <textarea class="form-control" id="note" name="note"
                                rows="3"><?php echo e(old('note', $diamond->note)); ?></textarea>
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <select class="form-control" id="admin_id" name="admin_id">
                                ...
                                <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($admin->id); ?>" <?php echo e(old('admin_id', $diamond->admin_id) == $admin->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CRM-Minimal-Carbon\CRM-Minimal-Carbon\resources\views/diamonds/edit.blade.php ENDPATH**/ ?>