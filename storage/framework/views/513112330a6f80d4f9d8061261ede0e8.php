    ...
    <div class="animate-up">
        <div class="auth-card mx-auto" style="max-width:900px;">
            ...
            <div class="auth-form bg-white">
                ...
                <form method="POST" action="<?php echo e(route('admin.login.post')); ?>" class="mt-3">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CRM-Minimal-Carbon\CRM-Minimal-Carbon\resources\views/auth/admin_login.blade.php ENDPATH**/ ?>