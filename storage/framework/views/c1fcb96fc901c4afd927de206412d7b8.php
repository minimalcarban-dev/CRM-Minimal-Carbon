...
<?php $__env->startSection('title', 'Create New Diamond'); ?>
...
<div class="diamond-management-container">
    ...
    <form action="<?php echo e(route('diamond.store')); ?>" method="POST" id="diamondForm" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="lot_no" name="lot_no"
                            value="<?php echo e(old('lot_no')); ?>" placeholder="e.g., L0010078" required>
                        <div class="form-hint">
                    ...
                    <div class="form-group">
                        ...
                        <select id="diamond_type" name="diamond_type" class="form-control themed-select">
                            ...
                            <?php $__currentLoopData = ($stoneTypes ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($stype->name); ?>" <?php echo e(old('diamond_type') == $stype->name ? 'selected' : ''); ?>>
                                <?php echo e($stype->name); ?>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <select id="shape" name="shape" class="form-control themed-select">
                                ...
                                <option value="<?php echo e($sshape->name); ?>" <?php echo e(old('shape') == $sshape->name ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <select id="cut" name="cut" class="form-control themed-select">
                                ...
                                <option value="<?php echo e($dcut->name); ?>" <?php echo e(old('cut') == $dcut->name ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select id="color" name="color" class="form-control themed-select">
                            ...
                            <option value="<?php echo e($scolor->name); ?>" <?php echo e(old('color') == $scolor->name ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select id="clarity" name="clarity" class="form-control themed-select">
                            ...
                            <option value="<?php echo e($dclar->name); ?>" <?php echo e(old('clarity') == $dclar->name ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="text" class="form-control" id="measurement" name="measurement"
                                value="<?php echo e(old('measurement')); ?>" placeholder="e.g., 6.5 x 6.3 x 4.1 mm">
                        </div>
                        <div class="form-hint">
                            <i class="bi bi-info-circle"></i>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="number" step="0.01" class="form-control" id="per_ct"
                                name="per_ct" value="<?php echo e(old('per_ct')); ?>" placeholder="Enter in INR">
                        </div>
                        <div class="form-hint">
                            <i class="bi bi-info-circle"></i>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="number" step="0.01" class="form-control" id="weight"
                                name="weight" value="<?php echo e(old('weight', 0)); ?>" placeholder="Carats">
                        </div>
                        <div class="form-hint">
                            <i class="bi bi-info-circle"></i>
                            Weight in carats
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="number" step="0.01" class="form-control" id="purchase_price"
                                name="purchase_price" value="<?php echo e(old('purchase_price')); ?>" readonly>
                        </div>
                        <div class="form-hint">
                            <i class="bi bi-info-circle"></i>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="number" step="0.01" class="form-control" id="margin"
                                name="margin" value="<?php echo e(old('margin')); ?>" required placeholder="Margin percentage">
                        </div>
                        <div class="form-hint">
                            <i class="bi bi-info-circle"></i>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="number" step="0.01" class="form-control" id="listing_price"
                                name="listing_price" value="<?php echo e(old('listing_price')); ?>" placeholder="Enter in INR">
                        </div>
                        <div class="form-hint">
                            <i class="bi bi-info-circle"></i>
                            Enter in INR → Auto-converted to USD on save
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="number" step="0.01" min="0" max="100" class="form-control" id="offer_calculation"
                                name="offer_calculation" value="<?php echo e(old('offer_calculation')); ?>" placeholder="Discount %">
                        </div>
                        <div class="form-hint">
                            <i class="bi bi-info-circle"></i>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="number" step="0.01" class="form-control" id="actual_listing_price"
                                name="actual_listing_price" value="<?php echo e(old('actual_listing_price')); ?>" readonly>
                        </div>
                        <div class="form-hint">
                            <i class="bi bi-info-circle"></i>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="number" step="0.01" class="form-control" id="shipping_price"
                                name="shipping_price" value="<?php echo e(old('shipping_price', 0)); ?>" placeholder="Enter in INR">
                        </div>
                        <div class="form-hint">
                            <i class="bi bi-info-circle"></i>
                            Enter in INR → Auto-converted to USD on save
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="sold_out_date" name="sold_out_date"
                            value="<?php echo e(old('sold_out_date')); ?>">
                    </div>

                    <div class="form-group">
                        <label for="is_sold_out" class="form-label">Status</label>
                        <select class="form-control" id="is_sold_out" name="is_sold_out" disabled>
                            <option value="IN Stock" <?php echo e(old('is_sold_out', 'IN Stock') == 'IN Stock' ? 'selected' : ''); ?>>IN Stock</option>
                            <option value="Sold" <?php echo e(old('is_sold_out') == 'Sold' ? 'selected' : ''); ?>>Sold</option>
                        </select>
                        <div class="form-hint">
                            <i class="bi bi-info-circle"></i>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="duration_days" name="duration_days"
                            value="<?php echo e(old('duration_days', 0)); ?>" readonly>
                        <div class="form-hint">
                            <i class="bi bi-info-circle"></i>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control" id="duration_price"
                            name="duration_price" value="<?php echo e(old('duration_price', 0)); ?>" readonly>
                        <div class="form-hint">
                            <i class="bi bi-info-circle"></i>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="number" step="0.01" class="form-control" id="sold_out_price"
                                name="sold_out_price" value="<?php echo e(old('sold_out_price')); ?>" placeholder="Enter in INR">
                        </div>
                        <div class="form-hint">
                            <i class="bi bi-info-circle"></i>
                            Enter in INR → Auto-converted to USD on save
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control" id="profit" name="profit"
                            value="<?php echo e(old('profit')); ?>" readonly>
                        <div class="form-hint">
                            <i class="bi bi-info-circle"></i>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="sold_out_month" name="sold_out_month"
                            value="<?php echo e(old('sold_out_month')); ?>" readonly placeholder="YYYY-MM">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-section-card">
            ...
            <div class="section-body">
                <div class="form-grid">
                    ...
                    <?php if(Auth::guard('admin')->user() && Auth::guard('admin')->user()->hasPermission('diamonds.assign')): ?>
                    <div class="form-group full-width">
                        <label for="admin_id" class="form-label">Assign To Admin</label>
                        <select class="form-control" id="admin_id" name="admin_id">
                            <option value="">-- Select Admin --</option>
                            <?php $__currentLoopData = \App\Models\Admin::orderBy('name')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CRM-Minimal-Carbon\CRM-Minimal-Carbon\resources\views/diamonds/create.blade.php ENDPATH**/ ?>