...
<?php $__env->startSection('title', 'Diamond Clarities'); ?>
    ...
    <div class="attr-list-container">
            ...
            <div class="attr-header-content">
                <div class="attr-header-left">
                    <div class="attr-breadcrumb-nav">
                        ...
                        <span class="attr-breadcrumb-current">Diamond Clarities</span>
                    </div>
                    <h1 class="attr-list-title"><i class="bi bi-stars"></i> Diamond Clarities</h1>
                    <p class="attr-list-subtitle">Manage all diamond clarities in your inventory</p>
                </div>
                <?php if($currentAdmin && $currentAdmin->hasPermission('diamond_clarities.create')): ?>
                    <div class="attr-header-right">
                        <a href="<?php echo e(route('diamond_clarities.create')); ?>" class="attr-btn-create"><i
                                class="bi bi-plus-circle"></i> Add Diamond Clarity</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="attr-filter-section">
            <form method="GET" class="attr-filter-form">
                ...
                <?php if(request('search')): ?><a href="<?php echo e(route('diamond_clarities.index')); ?>" class="attr-btn-reset"><i
        ...
        <div class="attr-table-card">
                        ...
                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="attr-row">
                                ...
                                <td class="attr-actions">
                                    <?php if($currentAdmin && $currentAdmin->hasPermission('diamond_clarities.view')): ?><a
                                        href="<?php echo e(route('diamond_clarities.show', $item->id)); ?>" class="attr-action-btn view"><i
                                    class="bi bi-eye"></i></a><?php endif; ?>
                                    <?php if($currentAdmin && $currentAdmin->hasPermission('diamond_clarities.edit')): ?><a
                                        href="<?php echo e(route('diamond_clarities.edit', $item->id)); ?>" class="attr-action-btn edit"><i
                                    class="bi bi-pencil"></i></a><?php endif; ?>
                                    <?php if($currentAdmin && $currentAdmin->hasPermission('diamond_clarities.delete')): ?>
                                        <form action="<?php echo e(route('diamond_clarities.destroy', $item->id)); ?>" method="POST"
            ...
            <?php else: ?>
                <div class="attr-empty-state">
                    ...
                    <h3>No diamond clarities found</h3>
                    <p>Get started by adding your first diamond clarity.</p><a href="<?php echo e(route('diamond_clarities.create')); ?>"
                        class="attr-btn-create"><i class="bi bi-plus-circle"></i> Add Diamond Clarity</a>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CRM-Minimal-Carbon\CRM-Minimal-Carbon\resources\views/diamond_clarities/index.blade.php ENDPATH**/ ?>