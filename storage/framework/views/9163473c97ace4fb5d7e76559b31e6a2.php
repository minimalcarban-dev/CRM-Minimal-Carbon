...
<?php $__env->startSection('title', 'Ring Sizes'); ?>
    ...
    <div class="attr-list-container">
            ...
            <div class="attr-header-content">
                <div class="attr-header-left">
                    <div class="attr-breadcrumb-nav">
                        ...
                        <span class="attr-breadcrumb-current">Ring Sizes</span>
                    </div>
                    <h1 class="attr-list-title"><i class="bi bi-circle"></i> Ring Sizes</h1>
                    <p class="attr-list-subtitle">Manage all ring sizes in your inventory</p>
                </div>
                <?php if($currentAdmin && $currentAdmin->hasPermission('ring_sizes.create')): ?>
                    <div class="attr-header-right">
                        <a href="<?php echo e(route('ring_sizes.create')); ?>" class="attr-btn-create"><i class="bi bi-plus-circle"></i> Add
                            Ring Size</a>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="attr-filter-section">
            <form method="GET" class="attr-filter-form">
                ...
                <?php if(request('search')): ?><a href="<?php echo e(route('ring_sizes.index')); ?>" class="attr-btn-reset"><i
        ...
        <div class="attr-table-card">
                        ...
                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="attr-row">
                                ...
                                <td class="attr-actions">
                                    <?php if($currentAdmin && $currentAdmin->hasPermission('ring_sizes.view')): ?><a
                                        href="<?php echo e(route('ring_sizes.show', $item->id)); ?>" class="attr-action-btn view"><i
                                    class="bi bi-eye"></i></a><?php endif; ?>
                                    <?php if($currentAdmin && $currentAdmin->hasPermission('ring_sizes.edit')): ?><a
                                        href="<?php echo e(route('ring_sizes.edit', $item->id)); ?>" class="attr-action-btn edit"><i
                                    class="bi bi-pencil"></i></a><?php endif; ?>
                                    <?php if($currentAdmin && $currentAdmin->hasPermission('ring_sizes.delete')): ?>
                                        <form action="<?php echo e(route('ring_sizes.destroy', $item->id)); ?>" method="POST"
            ...
            <?php else: ?>
                <div class="attr-empty-state">
                    ...
                    <h3>No ring sizes found</h3>
                    <p>Get started by adding your first ring size.</p><a href="<?php echo e(route('ring_sizes.create')); ?>"
                        class="attr-btn-create"><i class="bi bi-plus-circle"></i> Add Ring Size</a>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CRM-Minimal-Carbon\CRM-Minimal-Carbon\resources\views/ring_sizes/index.blade.php ENDPATH**/ ?>