...
<div class="notifications-management-container">
    ...
    <div class="stats-grid">
        <div class="stat-card stat-card-primary">
            ...
            <div class="stat-content">
                ...
                <div class="stat-value"><?php echo e($notifications->total()); ?></div>
        ...
        <div class="stat-card stat-card-warning">
            ...
            <div class="stat-content">
                ...
                <div class="stat-value"><?php echo e($notifications->where('read_at', null)->count()); ?></div>
                <div class="stat-trend">
    ...
    <div class="notifications-list">
        ...
        <div class="notification-card <?php echo e($notification->read_at ? 'read' : 'unread'); ?>">
            <div class="notification-indicator"></div>

            <div class="notification-icon">
                <?php if(isset($notification->data['type'])): ?>
                <?php if($notification->data['type'] === 'order'): ?>
                <i class="bi bi-basket"></i>
                <?php elseif($notification->data['type'] === 'user'): ?>
                <i class="bi bi-person"></i>
                <?php elseif($notification->data['type'] === 'system'): ?>
            ...
            <div class="notification-content">
                <div class="notification-header">
                    <h4 class="notification-title"><?php echo e($notification->data['title'] ?? 'Notification'); ?></h4>
                ...
                <?php if(isset($notification->data['details'])): ?>
                <div class="notification-details">
                    <?php $__currentLoopData = $notification->data['details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="notification-footer">
                    <div class="notification-time">
                        ...
                        <span class="time-relative"><?php echo e($notification->created_at->diffForHumans()); ?></span>
                        <span class="time-separator">•</span>
                        <span class="time-exact"><?php echo e($notification->created_at->format('M d, Y h:i A')); ?></span>
                    </div>
                    ...
                    <div class="notification-actions">
                        ...
                        <a href="<?php echo e($notification->data['action_url']); ?>"
                           class="action-btn <?php echo e($isExport ? 'btn-success' : 'btn-secondary'); ?>"
                           title="<?php echo e($notification->data['action_text'] ?? 'Open'); ?>"
                           style="display:inline-flex; align-items:center; gap:6px; text-decoration:none;">
                            ...
                            <?php endif; ?>
                            <span><?php echo e($notification->data['action_text'] ?? 'Open'); ?></span>
                        </a>
                        <?php endif; ?>
                        <?php if(!$notification->read_at): ?>
                        <button class="action-btn mark-read-btn" data-notification-id="<?php echo e($notification->id); ?>" title="Mark as read">
                            <i class="bi bi-check-circle"></i>
    ...
    <div class="empty-state">
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn-primary-custom">
...
<script>
    ...
    if (markAllReadBtn) {
        ...
        markAllReadBtn.addEventListener('click', async function(e) {
            ...
            try {
                const url = '<?php echo e(route("notifications.mark-all-read")); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CRM-Minimal-Carbon\CRM-Minimal-Carbon\resources\views/notifications/index.blade.php ENDPATH**/ ?>