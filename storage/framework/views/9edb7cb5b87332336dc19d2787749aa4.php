...
<?php $__env->startSection('title', 'Stone Shapes'); ?>
    ...
    <div class="attr-list-container">
        <div class="attr-list-header">
            <div class="attr-header-content">
                ...
                <?php if($currentAdmin && $currentAdmin->hasPermission('stone_shapes.create')): ?>
                    <div class="attr-header-right">
                        <a href="<?php echo e(route('stone_shapes.create')); ?>" class="attr-btn-create"><i class="bi bi-plus-circle"></i>
                            Add Stone Shape</a>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="attr-filter-section">
            <form method="GET" class="attr-filter-form">
                ...
                <?php if(request('search')): ?><a href="<?php echo e(route('stone_shapes.index')); ?>" class="attr-btn-reset"><i
        ...
        <div class="attr-table-card">
                        ...
                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="attr-row">
                                ...
                                <td class="attr-actions">
                                    <?php if($currentAdmin && $currentAdmin->hasPermission('stone_shapes.view')): ?><a
                                        href="<?php echo e(route('stone_shapes.show', $item->id)); ?>" class="attr-action-btn view"><i
                                    class="bi bi-eye"></i></a><?php endif; ?>
                                    <?php if($currentAdmin && $currentAdmin->hasPermission('stone_shapes.edit')): ?><a
                                        href="<?php echo e(route('stone_shapes.edit', $item->id)); ?>" class="attr-action-btn edit"><i
                                    class="bi bi-pencil"></i></a><?php endif; ?>
                                    <?php if($currentAdmin && $currentAdmin->hasPermission('stone_shapes.delete')): ?>
                                        <form action="<?php echo e(route('stone_shapes.destroy', $item->id)); ?>" method="POST"
            ...
            <?php else: ?>
                <div class="attr-empty-state">
                    ...
                    <p>Get started by adding your first stone shape.</p><a href="<?php echo e(route('stone_shapes.create')); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CRM-Minimal-Carbon\CRM-Minimal-Carbon\resources\views/stone_shapes/index.blade.php ENDPATH**/ ?>