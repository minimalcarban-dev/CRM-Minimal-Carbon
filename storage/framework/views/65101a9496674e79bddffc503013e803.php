...
<head>
    ...
    <script>
        window.authAdminId = <?php echo json_encode(Auth::guard('admin')->user()?->id ?? null, 15, 512) ?>;
        window.authAdminIsSuper = <?php echo json_encode(Auth::guard('admin')->user()?->is_super ?? false, 15, 512) ?>;
    ...
    <link href="<?php echo e(asset('css/diamond.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/attributes.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/tracker.css')); ?>" rel="stylesheet">
...
<body>
    ...
    <nav id="sidebar" class="sidebar">
        ...
        <!-- <div class="sidebar-header">
            <div class="logo-section">
                <a href="<?php echo e(route('admin.dashboard')); ?>">
                    <img src="<?php echo e(asset('images/Luxurious-Logo.png')); ?>" alt="Logo" class="logo-icon">
                </a>
            </div>
        </div> -->
        ...
        <div class="nav-section">
            <ul class="nav">
                <li>
                    <a class="nav-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>"
                        href="<?php echo e(route('admin.dashboard')); ?>" data-tooltip="Dashboard">
                        <i class="bi bi-house"></i>
                        <span>Dashboard</span>
                    </a>
                </li>

                <?php if(auth()->guard('admin')->user() && auth()->guard('admin')->user()->canAccessAny(['admins.view', 'admins.create'])): ?>
                    <li>
                        <a class="nav-link <?php echo e(request()->routeIs('admins.*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admins.index')); ?>" data-tooltip="Admins">
                ...
                <?php if(auth()->guard('admin')->user() && auth()->guard('admin')->user()->canAccessAny(['permissions.view', 'permissions.create'])): ?>
                    <li>
                        <a class="nav-link <?php echo e(request()->routeIs('permissions.*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('permissions.index')); ?>" data-tooltip="Permissions">
                ...
                <?php if(auth()->guard('admin')->user() && auth()->guard('admin')->user()->canAccessAny(['orders.view', 'orders.create'])): ?>
                    <li>
                        <a class="nav-link <?php echo e(request()->routeIs('orders.*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('orders.index')); ?>" data-tooltip="Orders">
                ...
                <?php if(auth()->guard('admin')->user() && auth()->guard('admin')->user()->canAccessAny(['invoices.view', 'invoices.create'])): ?>
                    <li>
                        <a class="nav-link <?php echo e(request()->routeIs('invoices.*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('invoices.index')); ?>" data-tooltip="Invoices">
                ...
                <?php if(auth()->guard('admin')->user() && auth()->guard('admin')->user()->canAccessAny(['parties.view', 'parties.create'])): ?>
                    <li>
                        <a class="nav-link <?php echo e(request()->routeIs('parties.*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('parties.index')); ?>" data-tooltip="Parties">
                            <i class="bi bi-people"></i>
                            <span>Parties</span>
                        </a>
                    </li>
                ...
                <?php if(auth()->guard('admin')->user() && auth()->guard('admin')->user()->canAccessAny(['chat.access'])): ?>
                    <li>
                        <a class="nav-link <?php echo e(request()->routeIs('chat.*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('chat.index')); ?>" data-tooltip="Chat" id="chatSidebarLink">
                ...
                <?php if(auth()->guard('admin')->user() && auth()->guard('admin')->user()->canAccessAny(['leads.view', 'leads.create'])): ?>
                    <li>
                        <a class="nav-link <?php echo e(request()->routeIs('leads.*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('leads.index')); ?>" data-tooltip="Leads Inbox">
                ...
                <?php if(auth()->guard('admin')->user() && auth()->guard('admin')->user()->canAccessAny(['meta_leads.settings'])): ?>
                    <li>
                        <a class="nav-link <?php echo e(request()->routeIs('settings.meta.*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('settings.meta.index')); ?>" data-tooltip="Meta Settings">
                ...
                <?php if(auth()->guard('admin')->user() && auth()->guard('admin')->user()->canAccessAny(['diamonds.view', 'diamonds.create'])): ?>
                    <li>
                        <a class="nav-link <?php echo e(request()->routeIs('diamond.index') || (request()->routeIs('diamond.*') && !request()->routeIs('diamond.job.*')) ? 'active' : ''); ?>"
                            href="<?php echo e(route('diamond.index')); ?>" data-tooltip="Diamonds">
                            <i class="bi bi-gem"></i>
                            <span>Stock List</span>
                        </a>
                    </li>
                    <li>
                        <a class="nav-link <?php echo e(request()->routeIs('diamond.job.*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('diamond.job.history')); ?>" data-tooltip="Job History">
                ...
                ?>
                <?php if(auth()->guard('admin')->user() && auth()->guard('admin')->user()->canAccessAny(['purchases.view', 'purchases.create', 'expenses.view', 'expenses.create'])): ?>
                    <div class="nav-dropdown">
                        <button class="dropdown-toggle-link <?php echo e($expensesActive ? 'active' : ''); ?>" id="expensesDropdown"
                            data-tooltip="Expenses" data-initial-open="<?php echo e($expensesActive ? '1' : '0'); ?>" type="button"
                        ...
                        <div class="dropdown-menu-custom <?php echo e($expensesActive ? 'show' : ''); ?>" id="expensesMenu">
                            <ul class="nav">
                                <?php if(auth()->guard('admin')->user()->canAccessAny(['purchases.view', 'purchases.create'])): ?>
                                    <li>
                                        <a class="nav-link <?php echo e(request()->routeIs('purchases.*') ? 'active' : ''); ?>"
                                            href="<?php echo e(route('purchases.index')); ?>" data-tooltip="Purchase Tracker">
                                            <i class="bi bi-cart-check"></i>
                                            <span>Purchase Tracker</span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                <?php if(auth()->guard('admin')->user()->canAccessAny(['expenses.view', 'expenses.create'])): ?>
                                    <li>
                                        <a class="nav-link <?php echo e(request()->routeIs('expenses.*') ? 'active' : ''); ?>"
                                            href="<?php echo e(route('expenses.index')); ?>" data-tooltip="Office Expenses">
            ...
            ?>
            <div class="nav-dropdown">
                <button class="dropdown-toggle-link <?php echo e($attributesActive ? 'active' : ''); ?>" id="attributesDropdown"
                    data-tooltip="Attributes" data-initial-open="<?php echo e($attributesActive ? '1' : '0'); ?>" type="button"
                    aria-expanded="false" style="padding-left: 23px;">
                    <div class="left-content">
                ...
                <div class="dropdown-menu-custom <?php echo e($attributesActive ? 'show' : ''); ?>" id="attributesMenu">
                    <ul class="nav">
                        ...
                        <?php if(
                            ...
                            <li>
                                <a class="nav-link <?php echo e(request()->routeIs('companies.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('companies.index')); ?>" data-tooltip="Companies">
                        ...
                        <?php if(
                            ...
                            <li>
                                <a class="nav-link <?php echo e(request()->routeIs('metal_types.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('metal_types.index')); ?>" data-tooltip="Metal Types">
                        ...
                        <?php if(
                            ...
                            <li>
                                <a class="nav-link <?php echo e(request()->routeIs('setting_types.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('setting_types.index')); ?>" data-tooltip="Setting Types">
                                    <i class="bi bi-gear"></i>
                        ...
                        <?php if(
                            ...
                            <li>
                                <a class="nav-link <?php echo e(request()->routeIs('closure_types.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('closure_types.index')); ?>" data-tooltip="Closure Types">
                        ...
                        <?php if(
                            ...
                            <li>
                                <a class="nav-link <?php echo e(request()->routeIs('ring_sizes.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('ring_sizes.index')); ?>" data-tooltip="Ring Sizes">
                        ...
                        <?php if(
                            ...
                            <li>
                                <a class="nav-link <?php echo e(request()->routeIs('stone_types.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('stone_types.index')); ?>" data-tooltip="Stone Types">
                                    <i class="bi bi-gem"></i>
                        ...
                        <?php if(
                            ...
                            <li>
                                <a class="nav-link <?php echo e(request()->routeIs('stone_shapes.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('stone_shapes.index')); ?>" data-tooltip="Stone Shapes">
                        ...
                        <?php if(
                            ...
                            <li>
                                <a class="nav-link <?php echo e(request()->routeIs('stone_colors.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('stone_colors.index')); ?>" data-tooltip="Stone Colors">
                        ...
                        <?php if(
                            ...
                            <li>
                                <a class="nav-link <?php echo e(request()->routeIs('diamond_clarities.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('diamond_clarities.index')); ?>" data-tooltip="Diamond Clarities">
                        ...
                        <?php if(
                            ...
                            <li>
                                <a class="nav-link <?php echo e(request()->routeIs('diamond_cuts.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('diamond_cuts.index')); ?>" data-tooltip="Diamond Cuts">
    ...
    <div class="top-navbar">
        <div class="navbar-content">
            <div class="navbar-left">
                ...
                <h2 class="navbar-title"><?php echo $__env->yieldContent('title', 'Admin Panel'); ?></h2>
            </div>
            <div class="navbar-right">
                ...
                <div class="notification-dropdown">
                    <button class="notification-btn" id="notificationBtn">
                        ...
                        <?php if(auth()->guard('admin')->user() && auth()->guard('admin')->user()->unreadNotifications->count() > 0): ?>
                            <span
                                class="notification-badge"><?php echo e(auth()->guard('admin')->user()->unreadNotifications->count()); ?></span>
                        <?php endif; ?>
                    </button>
                        ...
                        <div class="notification-list">
                            <?php if(auth()->guard('admin')->user()): ?>
                                <?php if(auth()->guard('admin')->user()->unreadNotifications->count() > 0): ?>
                                    <?php $__currentLoopData = auth()->guard('admin')->user()->unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="notification-item unread" data-notification-id="<?php echo e($notification->id); ?>"
                                            data-url="<?php echo e($notification->data['url'] ?? '#'); ?>">
                                            <div class="notification-icon">
                                                <?php if($notification->type === 'App\Notifications\DiamondAssignedNotification'): ?>
                                                    <i class="bi bi-gem"></i>
                                                <?php elseif($notification->type === 'App\Notifications\ChatMentionNotification'): ?>
                                                    <i class="bi bi-at"></i>
                                                <?php elseif($notification->type === 'App\Notifications\DiamondReassignedNotification'): ?>
                                                    <i class="bi bi-arrow-repeat"></i>
                                                <?php elseif($notification->type === 'App\Notifications\ImportCompleted'): ?>
                                                    <i class="bi bi-cloud-upload"
                                                        style="color: <?php echo e($notification->data['icon_color'] ?? 'info'); ?>"></i>
                                                <?php elseif($notification->type === 'App\Notifications\ExportCompleted'): ?>
                                                    <i class="bi bi-cloud-download"
                                                        style="color: <?php echo e($notification->data['icon_color'] ?? 'success'); ?>"></i>
                                                <?php elseif($notification->type === 'App\Notifications\DiamondSoldNotification'): ?>
                                            ...
                                            <div class="notification-content">
                                                <p class="notification-message">
                                                    <?php if(isset($notification->data['title'])): ?>
                                                        <strong><?php echo e($notification->data['title']); ?></strong><br>
                                                    <?php endif; ?>
                                                ...
                                                <?php if(isset($notification->data['message_preview']) && $notification->type === 'App\Notifications\ChatMentionNotification'): ?>
                                                    <p class="notification-preview"
                                                        style="font-size: 0.85rem; color: #64748b; margin-top: 0.25rem; font-style: italic;">
                                                        <?php echo $notification->data['message_preview']; ?>

                                                    </p>
                                                <?php endif; ?>
                                                <?php if($notification->type === 'App\Notifications\ExportCompleted' && isset($notification->data['action_url'])): ?>
                                            ...
                                            <button class="notification-close"
                                                onclick="closeNotification('<?php echo e($notification->id); ?>')">
                                                <i class="bi bi-x"></i>
                                            </button>
                                        </div>
                                ...
                                <?php if(auth()->guard('admin')->user()->readNotifications->count() > 0): ?>
                                    <div class="notification-divider">
                                        <span>Earlier</span>
                                    </div>
                                    <?php $__currentLoopData = auth()->guard('admin')->user()->readNotifications->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="notification-item read" data-url="<?php echo e($notification->data['url'] ?? '#'); ?>">
                                            <div class="notification-icon">
                                                <?php if($notification->type === 'App\Notifications\DiamondAssignedNotification'): ?>
                                                    <i class="bi bi-gem"></i>
                                                <?php elseif($notification->type === 'App\Notifications\ChatMentionNotification'): ?>
                ...
                <div class="profile-dropdown">
                    <button class="profile-btn" id="profileBtn">
                        <div class="profile-avatar">
                            <?php echo e(strtoupper(substr(auth()->guard('admin')->user()->name ?? 'A', 0, 2))); ?>
                    ...
                    <div class="profile-menu" id="profileMenu">
                        <div class="profile-header">
                            <p class="profile-name"><?php echo e(auth()->guard('admin')->user()->name ?? 'Admin'); ?></p>
                            <p class="profile-email"><?php echo e(auth()->guard('admin')->user()->email ?? ''); ?></p>
                        </div>
...
</html><?php /**PATH D:\CRM-Minimal-Carbon\CRM-Minimal-Carbon\resources\views/layouts/admin.blade.php ENDPATH**/ ?>