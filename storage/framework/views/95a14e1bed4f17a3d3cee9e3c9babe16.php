    ...
    <div class="container-fluid">
        ...
        <div class="page-header mb-4">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div>
                    ...
                    <p class="page-subtitle mb-0">Configure access rights for <?php echo e($admin->name); ?></p>
                </div>
        ...
        <div class="admin-info-card mb-4">
            ...
            <div class="admin-stats">
                <div class="stat-item">
                    <div class="stat-value" id="selectedCount"><?php echo e(count($assignedPermissions)); ?></div>
                    <div class="stat-label">Assigned</div>
                </div>
                <div class="stat-divider"></div>
                <div class="stat-item">
                    <div class="stat-value" id="totalCount"><?php echo e($permissionsByCategory->flatten()->count()); ?></div>
            ...
            <div class="super-admin-toggle">
                <div class="form-check form-switch">
                    <input class="form-check-input super-admin-switch" 
                            ...
                            <?php echo e($admin->is_super ? 'checked' : ''); ?>>
                    <label class="form-check-label" for="isSuperAdmin">
                        <?php echo e($admin->is_super ? 'Active' : 'Inactive'); ?>
        ...
        <!-- Permissions Form -->
        <form method="POST" action="<?php echo e(route('admins.permissions.update', $admin)); ?>" id="permissionsForm">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            
            <!-- Hidden input for Super Admin status (synced via JS from the toggle above) -->
            <input type="hidden" name="is_super" id="isSuperHidden" value="<?php echo e($admin->is_super ? '1' : '0'); ?>">
            ...
            <div class="permissions-grid">
                <?php $__currentLoopData = $permissionsByCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $permissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="permission-category-card" data-category="<?php echo e($category); ?>">
                        <div class="category-header" onclick="toggleCategory(this)">
                            <div class="category-info">
                                <div class="category-icon">
                                    <i class="bi bi-<?php echo e($loop->iteration % 2 == 0 ? 'star' : 'lightning'); ?>-fill"></i>
                                </div>
                                <div>
                                    <h5 class="category-title">
                                        <?php echo e(ucwords(str_replace('_', ' ', $category ?: 'General'))); ?>

                                    </h5>
                                    <p class="category-count">
                                        <span class="selected-count">0</span> / <?php echo e(count($permissions)); ?> selected
                                    </p>
                                </div>
                            </div>
                            <div class="category-actions">
                                <div class="form-check form-switch" onclick="event.stopPropagation()">
                                    <input class="form-check-input category-select-all" 
                                            type="checkbox" 
                                            id="select-all-<?php echo e($category); ?>"
                                            data-category="<?php echo e($category); ?>">
                                    <label class="form-check-label" for="select-all-<?php echo e($category); ?>">
                                        Select All
                                    </label>
                                </div>
                                    ...
                                    <div class="permission-item" data-permission-id="<?php echo e($permission->id); ?>">
                                        <div class="form-check">
                                            <input class="form-check-input permission-checkbox" 
                                                    ...
                                                    data-category="<?php echo e($category); ?>"
                                                    <?php if(in_array($permission->id, $assignedPermissions)): echo 'checked'; endif; ?>>
                                            <label class="form-check-label" for="permission-<?php echo e($permission->id); ?>">
                                                ...
                                                <span class="permission-slug"><?php echo e($permission->slug); ?></span>
                                                <?php if($permission->description): ?>
                                                    <span class="permission-description"><?php echo e($permission->description); ?></span>
                                                <?php endif; ?>
                                            </label>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CRM-Minimal-Carbon\CRM-Minimal-Carbon\resources\views/admins/permissions.blade.php ENDPATH**/ ?>