...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="page-header mb-4">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    <a href="<?php echo e(route('permissions.index')); ?>" class="btn btn-outline-secondary">
        ...
        <form method="POST" action="<?php echo e(route('permissions.store')); ?>" id="createPermissionForm">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="col-12">
                            <div class="form-group-modern">
                                ...
                                <input type="text" name="name" id="permission_name" class="form-control-modern"
                                    value="<?php echo e(old('name')); ?>" placeholder="e.g., Create User, View Reports, Edit Settings"
                                    required>
                        ...
                        <div class="col-12">
                            <div class="form-group-modern">
                                ...
                                <input type="text" name="category" id="permission_category" class="form-control-modern"
                                    list="permission_categories" value="<?php echo e(old('category')); ?>"
                        ...
                        <div class="col-12">
                            <div class="form-group-modern">
                                ...
                                <textarea name="description" id="permission_description" class="form-control-modern"
                                    rows="4"
                                    placeholder="Describe when and why this permission should be granted..."><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CRM-Minimal-Carbon\CRM-Minimal-Carbon\resources\views/permissions/create.blade.php ENDPATH**/ ?>